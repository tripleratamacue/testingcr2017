...
var CUCUMBER_EVENTS = ['handleBeforeFeature', 'handleAfterFeature', 'handleBeforeScenario', 'handleAfterScenario', 'handleBeforeStep', 'handleStepResult'];
...
var HookRunner = function () {
    ...
    (0, _createClass3.default)(HookRunner, [{
        ...
        value: function handleBeforeFeature(event) {
            var feature = event;
        ...
        value: function handleBeforeScenario(event) {
            var scenario = event;
            var done = arguments[1];
        ...
        value: function handleBeforeStep(event) {
            var step = event;
            var done = arguments[1];
        ...
        value: function handleStepResult(event) {
            var stepResult = event;
            var done = arguments[1];
        ...
        value: function handleAfterScenario(event) {
            var scenario = event;
            var done = arguments[1];
        ...
        value: function handleAfterFeature(event) {
            var feature = event;
            var done = arguments[1];
